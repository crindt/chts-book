...
setwd("~/Suman_research/Caltrans Project/Weight/HHWeight_County")
...
tot.hh <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Weight/Data_County/Total/county_tothh2.csv", header=TRUE)
...
```{r,cache=TRUE}
# Household size data
hhsize.county <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Weight/Data_County/County_HH/HHsize/hhsize.csv", header=TRUE)
head(hhsize.county)
...
```{r,cache=TRUE}
# Income
hhincome.county <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Weight/Data_County/County_HH/Income/hhincome.csv", header=TRUE)
...
hhveh.county <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Weight/Data_County/County_HH/HHVeh/hhvehicle.csv", header=TRUE)
head(hhveh.county)
...
```{r,cache=TRUE}
## Number of workers
hhwrk.county <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Weight/Data_County/County_HH/Worker/hhworkers.csv", header=TRUE)
head(hhwrk.county)
...
setwd("~/Suman_research/Caltrans Project/Weight/HHWeight_County")
# Import the files
filenames <- list.files(path = "~/Suman_research/Caltrans Project/Weight/HHWeight_County")
