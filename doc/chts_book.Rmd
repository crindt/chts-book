...
2. a set of interviews with staff at Caltrans headquarters and three
   selected Caltrans Districts to better understand how they could
   benefit from using 2010-12 CHTS data and to help promote the use in
   their work of CHTS data;
...
4. provide on-call statistical support to Caltrans staff from the
   Office of Travel Forecasting and Analysis; and

5. creation of a reference book of useful statistical commands based
...
Comparable commerical packages, such as Stata, cost thousands of
...
There are a wealth of tutorials, articles, and examples to help you
...
```{r child = '3.Diagnostic.Rmd',cache=FALSE}
```
...
```{r child = '4.1Personweights.Rmd',cache=FALSE}
```
