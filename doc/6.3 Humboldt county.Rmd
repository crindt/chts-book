...
setwd(pd("District 1/Humboldt County"))
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Mode_23d.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
temp3
## Save as csv file
write.csv(temp3,file=pto("TripDUrm_D23.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
rm(temp)
...
temp3
## Save as csv file
write.csv(temp3,file=pto("TripDistanceM_D23.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
rm(temp)
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Mode_23Ddrialn.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Mode_23O.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Mode_23Odrialn.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Actpur_23O.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Mode_wact23O.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
temp3
## Save as csv file
write.csv(temp3,file=pto("Actpur_23D.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
...
```{r hc-47,cache=TRUE}
## Save as csv file
write.csv(temp3,file=pto("Mode_wact23D.csv"),row.names=FALSE)
rm(temp1)
rm(temp2)
rm(temp3)
```
