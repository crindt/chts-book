...
setwd("~/Suman_research/Caltrans Project/Weight/PersonWeight_County")
# Import the files
filenames <- list.files(path = "~/Suman_research/Caltrans Project/Weight/PersonWeight_County")
...
```{r,cache=TRUE}
# Save 
setwd("~/Suman_research/Caltrans Project/Weight/NewWeightData")
...
```{r,cache=TRUE}
# Random Check
setwd("~/Suman_research/Caltrans Project/Weight/Check")
...
place_data1 <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Data/deliv_place.csv", header=TRUE)
