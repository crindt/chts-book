...
```{r results='asis',echo=FALSE,cache=TRUE}
############################################################ NESTABLE SECTION
SEC('##',"TABLE 54: Daily Travel Statistics by Weekday vs Weekend")
...
```{r results='asis',echo=FALSE,cache=TRUE}
SEC("#","Writing Tables for Use with Other Programs")
```
...
```{r rt-write-csv,cache=TRUE}
# Set CSV output dir
csvout <- paste(rd,"csvout",sep="/")
