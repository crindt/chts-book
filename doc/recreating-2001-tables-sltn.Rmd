...
for (var in sort(unique(res.11$County))) {
  ...
  tab <- pandoc.table.return(
    dat,
    caption=paste("TABLE 11: Weekday Driver Trips Per Household (",var,")",sep=""),
    split.table=Inf,split.cells=Inf,
    big.mark=',',
    round=1,
    #               justify=c('left','left','right','right','right'),
...
for (var in sort(unique(res.13$County))) {
  ...
  tab <- pandoc.table.return(
    dat,
    caption=paste("TABLE 13: Weekday Person and Driver Trips Per Household (",var,")",sep=""),
    split.table=Inf,split.cells=Inf,
    big.mark=',',
    round=1,
    #               justify=c('left','left','right','right','right'),
...
for (var in sort(unique(res.15$County))) {
  ...
  tab <- pandoc.table.return(
    dat,
    caption=paste("TABLE 15: Weekday Driver Trips Per Vehicle (",var,")",sep=""),
    split.table=Inf,split.cells=Inf,
    big.mark=',',
    round=1,
    #               justify=c('left','left','right','right','right'),
