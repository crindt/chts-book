...
summary(CTFIP)
sd(CTFIP)
boxplot(CTFIP,xlab=c("Residential county"),col=c("gold"))
...
boxplot(SUBAMT,xlab=c("Subsidized amount"),col=c("orange"))
...
#rename the added variables
names(nplace_data) [c(46,47,48,51,52,54)]<-c("PNAME","CITY","ZIP","CTFIP","TRACT","PPrimaryCity")
