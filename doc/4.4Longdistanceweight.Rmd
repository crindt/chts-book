...
tot.pop <- read.csv(p("Weight/Data_County/Total/county_totpop2.csv"),
                    header=TRUE)
head(tot.pop)
...
```{r ldw-15,cache=TRUE}
# Hispanic data
hisp.county <- read.csv(p("Weight/Data_County/Hispanic/Hisp_county.csv"),
                        header=TRUE)
head(hisp.county)
...
```{r ldw-16,cache=TRUE}
# Race
race.county <- read.csv(p("Weight/Data_County/Race/Race_county.csv"),
                        header=TRUE)
...
```{r ldw-17,cache=TRUE}
## Employment data
emply.county <- read.csv(p("Weight/Data_County/Employment/Employment_county.csv"),
                         header=TRUE)
...
```{r ldw-18,cache=TRUE}
#Gender
gend.county <- read.csv(p("Weight/Data_County/Gender/Gender_county.csv"),
                        header=TRUE)
...
# Age
age.county <- read.csv(p("Weight/Data_County/Age/Age_county.csv"),
                       header=TRUE)
head(age.county)
...
```{r ldw-25,cache=TRUE}
write.csv(wLDdata,
          file=p(paste("Weight/LD_Weight2","wLD_data922015.csv",sep="/")),
          row.names=FALSE)
```
