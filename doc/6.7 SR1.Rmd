...
a trip. We only considered the purpose code (`APURP`) 9 for work
trips. We generated every table for both unweighted and weighted
results using countywide weights for the latter.
