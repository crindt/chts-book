...
as a trip.  We only considered work trips\ifmydocumentation (purpose
code `APURP=9`)\fi. We generated every table for both unweighted and
weighted results using countywide weights for the latter.
