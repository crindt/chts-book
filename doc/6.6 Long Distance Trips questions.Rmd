...
setwd("~/Suman_research/Caltrans Project/LD data request")

#Import the long distance  (with new weight) csv file and give a new name
wLDdata <- read.csv("c:/Users/user/Documents/Suman_research/Caltrans Project/Weight/LD_Weight2/wLD_data13015.csv", header=TRUE)
names(wLDdata)
```
